  ...
  fire: {
    ...
    wingForms: [
      ...
      { tips: [[2.40, 0.26], [1.90, -0.50], [1.25, -0.70], [0.70, -0.60]],
        ...
        arc: { bow: 0.40, hump: 0.05, humpAt: 0.58, hook: 0.0 } },
      ...
      { tips: [[3.40, 0.34], [2.85, -0.55], [2.10, -1.00], [1.30, -1.15], [0.70, -0.95]],
        ...
        arc: { bow: 0.55, hump: 0.32, humpAt: 0.58, hook: 0.35 } },
      // F2 radiant — full broad fanned wing: deep chord, strong elbow, raked fire hook.
      { tips: [[4.00, 0.42], [3.40, -0.55], [2.60, -1.05], [1.75, -1.30], [0.95, -1.12]],
        lead: [2.90, 0.66], scallop: 0.26, rootChord: 0.70, flame: false,
        arc: { bow: 0.70, hump: 0.50, humpAt: 0.60, hook: 0.70 } },
    ],
    forms: [
