...
### L248 — A later multi-stage form REUSES the earlier rig (pose it, don't duplicate it) — the tri budget forbids a third wing set; add only the cheap central motifs, gated so the earlier stages stay byte-identical
