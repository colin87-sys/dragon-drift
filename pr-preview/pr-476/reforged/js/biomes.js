...
export const BIOMES = [
  ...
  },
  {
    ...
    godrayMul: 0.26,   // Fable R3: after the mask-blur + radial-shear soften, trim once more — storm-filtered sun is FELT not read (floor ~0.24; below that the eye-breach statement dies)
