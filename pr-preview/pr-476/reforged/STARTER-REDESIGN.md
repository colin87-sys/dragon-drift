# STARTER-REDESIGN.md — The Starter Redesign Playbook (aesthetics first)

*(Renamed 2026-07-12 from `DRAGON-DESIGN.md` — that name now carries the shape-agnostic
premium-creature method distilled from the Vesper/Solar/Phoenix arcs. This file remains the
authority for the STARTER trio's build sheets, bands, and gate prompt; external references
to "DRAGON-DESIGN §N" written before 2026-07-12 mean THIS file's §N.)*
