...
DRAGONS.pearlRedesign = {
  ...
  surgeHi: 0x4CC6FF,   // SATURATED dawn-cyan ignition → on a white-value seraph the Surge reads as a HUE+bloom shift (white→cyan), not a brightness bump that a bright cruise wing can't show
