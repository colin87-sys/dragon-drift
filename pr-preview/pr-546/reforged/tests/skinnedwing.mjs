...
if (!DRAGONS.obsidian) { console.log('\nskinnedwing: SKIP — obsidian retired from roster (no live subject)'); process.exit(0); }
...
ob.group.traverse((o) => {
  if (!wingPiece(o)) return;   // wing pieces only (tail tube → sweptail.mjs, bridge → shoulderbridge.mjs)
  checked++;
