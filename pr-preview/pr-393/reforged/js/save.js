...
const DEFAULTS = {
  ...
  settings: { qualityOverride: null, modelDetail: null, reticle: true, slowMo: true, glideAssist: false, mouseSteer: true, bulletClarity: true, dev: false,
    ...
    dither: true, toneMap: 'aces', particleBatch: false, skyIbl: false, heroShadow: false, propAO: false, atmosphere: false, skyClouds: false, waterSwell: false, waterDepth: false },
  embers: 0,
  xp: 0,
  level: 1,
