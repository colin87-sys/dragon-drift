...
assertEq(sssr.length, 12, 'exactly 12 Eternal-capable (SSSR, procedural) dragons');   // 7 core +vesper +vesperLean +revenant +tempest +forgewing (the wing-lab test article)
