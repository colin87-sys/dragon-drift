...
const SPECS = {
  azure: {
    ...
    eyeHead: [[0.30, 0.45], [0.20, 0.30], [0.14, 0.28]], // §4 eye diameter : head length. f2 ceiling RECONCILED 0.185→0.28: at 0.185 the honest gate read the apex eyes as "tiny specks on a whale slab — the payoff form with the least life"; eyeScale 0.85 (~0.26) keeps them the ladder's smallest/keenest but READABLE (L147: reconcile the proxy to what the eye measures)
