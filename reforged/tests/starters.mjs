...
const SPECS = {
  ...
  jade: {
    ...
    triTargets: [2650, 4200, 5350],              // AAA r1 reconciled to the premium-rebuild geometry (18-col koi-scale body loft + folded ribbon streamers), still well under the 6000/form ceiling. Was [2550,3680,5200] pre-rebuild.
