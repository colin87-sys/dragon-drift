...
| 8 | Neck wide at chest → narrows to skull | **BUILT** | The flat neck-cap is gone: body clips at `NECK_BASE=0.235`, a tapered neck tube (r 0.40→0.27) carries a sculpted head. Head = a sleek lofted wedge (tall cranium → tapering snout, egg cross-section), brow ridges + glowing eyes (`matCore`), back-swept horns (crown), dorsal snout spikes. Reads as a celestial dragon head from the rear cam + ¾ + side. First pass — feel judged on the PR preview. |
