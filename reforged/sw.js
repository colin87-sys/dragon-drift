...
const VERSION = 'e070bf721dd4';                          // STAMP:VERSION
const ASSETS = [
  './',
  './css/style.css',
  './index.html',
  ...
  './js/celestialDef.js',
  './js/celestialModel.js',
  './js/celestialSpine.js',
  './js/celestialStormSilhouette.js',
  './js/celestialStormSpec.js',
  './js/celestialTrace.js',
  './js/collision.js',
  './js/config.js',
  './js/contactShadow.js',
