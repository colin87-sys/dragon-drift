...
export const DRAGONS = {
  ...
  cindervale: {
    ...
    forms: [
      // Cinderkip — cute starter: large eyes, horn buds, compact wings, simple
      // glowing tail-spade. Fire identity is a lively ember tail/core, not an
      // orange body.
      ...
      // Ashvein — lean rebellious middle: longer neck, sharper predator head,
      // 4-finger flame-notched wings and developed tail stabilizers. It is cool,
      // but it intentionally lacks the final crown and massive wing authority.
      { wingForm: 1, tailStyle: 'twinfin',
        bodyScale: 0.88, wingSpan: 0.96, wingChord: 1.42, tailLength: 0.94,
        tailFinScale: 0.58, tailFinSpread: 0.52, tailGlowSegs: 4,
        neckSegments: 5, ridgeCount: 8,
      ...
      // Pyroclast Sovereign — final power spike: crown-horned noble head, deep
      // chest/shoulder platform, huge 5-finger M wings, broad tail rudders and
      // controlled white-hot furnace seams.
      { wingForm: 2, tailStyle: 'apexstealth',
