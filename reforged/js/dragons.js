...
export const DRAGONS = {
  ...
  fornax: {
    ...
    model: {
      ...
      // silhouette + hull (§2/§4)
      hullLadder: 1, headScale: 1.6, eyeScale: 0.6, tailLength: 1.0,
    ...
    rimCruise: 0x140a04, rimCruiseBase: 0.12, rimPowerMul: 2.0, rimWingMul: 0.18,   // rimCruise is a COLOR; near-dark warm, coal-not-torch
