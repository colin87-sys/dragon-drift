  ...
  jade: {
    ...
    forms: [
      ...
      { headScale: 0.68, snoutScale: 0.54, eyeScale: 0.74, eyeShape: 0.78, cuteEye: false,   // solid luminous-green gem eye (no black cartoon pupil) — Fable gate r7
        ...
        riverGleam: true, gleamColor: 0x9ff0c8, gleamBase: 0.4,   // CP3 PREMIUM: the WITHHELD river-gleam — a per-vertex aGlow mask lights ONLY the fan-ray tips, tail-leaf points, whisker beads + a thin dorsal line; a subtle mint dew at cruise (breathes with the swim), FLOODING on Surge (casOverall). The tube never floods — withheld glow, the Tempest signature-ignition trick in jade's green lane. Apex-only.
