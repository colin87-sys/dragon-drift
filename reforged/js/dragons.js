...
export const DRAGONS = {
  ...
  ember: {
    ...
    model: {
      ...
      tongueCount: 5, maneSweep: 0.5, maneDihedral: 0.26, maneChord: 0.5, maneCamber: 0.22,
      maneDetail: 1.0, maneRakeDown: 0.16, maneGlow: 0.5,   // base emissive kept under the bloom threshold (1.0) so the wing glows warm, never blooms to white in-game
      maneMid: 0x8a2a0c, maneTipColor: 0xff9a34, maneArmColor: 0x7a3216,
      sparColor: 0xc0763c,
