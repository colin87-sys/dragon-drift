...
function tick() {
  ...
  if (game.state !== 'paused') {
    ...
    if (sunFacing > 0.05) {
      ...
      // Lumen Mire's "nothing shines from the sky" night keeps only a dim residue.
