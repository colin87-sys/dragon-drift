...
// (the Calamities opener); slot 8 is BRINEHOLM (a Calamity — the bound leviathan).
// CRAGHOLD is RETIRED (§5b L130) — its def + builder stay for the geometry-lesson
// lineage and its own telegraph test, but it is OUT of the encounter rotation.
// NOTE: slot 7 THRUMSWARM lands before BRINEHOLM in the registry; until its PR
// merges, BRINEHOLM sits at the tail of BOSS_ORDER (the next encounter after
// HOLLOWGATE). THRUMSWARM's PR inserts 'thrumswarm' before 'brineholm' here.
export const BOSS_ORDER = ['voidmaw', 'stormrend', 'ashtalon', 'marrowcoil', 'eitherwing', 'hollowgate', 'brineholm'];
