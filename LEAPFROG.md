...
## L256 — Attack-pattern audit: a dread is only real if its GEOMETRY (not its card name) delivers the counter-verb; grep the code, not the doc, for "same-set + faster" and orphaned state fields
