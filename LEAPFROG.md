...
## L241 — UNLEASH PHRASE PR-A: beat-lock via the queue you already have; presentation clocks are free, damage clocks are LAW; a riser must be built cancellable (stepped points, not one long ramp)
...
## L242 — Skill-expression LAW: never auto-snap what the player's timing earns; a playtest LAB is two gated lines when damage is the root of all state change

**Did / learned.** Two same-branch follow-ups to PR-A (#302), both owner-driven:
