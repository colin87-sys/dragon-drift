...
### L168 — LANCE PR1 (V1 AIM-LINE): a dependency-injected state machine is unit-testable in the browser via a live `import()`; and "aim at an organ" needs the organ to be NAMED
