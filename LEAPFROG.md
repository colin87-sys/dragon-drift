...
### L226 — Mirror-frame symmetry has TWO different sign rules depending on WHERE the mirror lives in the chain; a shared wing poser had both, wrong, on the same rig
